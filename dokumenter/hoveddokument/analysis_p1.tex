...
\end{compactitem}
\subsection{Krav}
Oppdragsgivers krav er at vi skal ha minst én operativ værstasjon i Hessdalen der minst én til to typer for værdata blir logget. Værstasjonene må bygges med µP-kortet (Ethernut 2.1) som mikrokontroller. Data skal være visuelt presentert på www.hessdalen.org, og gi mulighet for brukerene å velge et gitt tidsintervall de vil se data fra. Data må kunne presenteres på både kurveform og tabellform. 
