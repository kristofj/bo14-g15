...
\begin{compactitem}
	\item Har fått til kommunikasjon mellom ethernutkortet og server. Oppdatert databasen til å innfrie nye krav. (Kristoffer og Mikael)
	\item Har fått satt opp kretsskjema for temperatur- og luftfuktighetsensoren, og satt opp til trykksensoren. Mangler å skaffe zenerdiode og motstander til sikkerhetskretsen. (Morten og Kristian)
	\item Har fått laget skallet til hovedrapporten (Kristian)
\end{compactitem}
